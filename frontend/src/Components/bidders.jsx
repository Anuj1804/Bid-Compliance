...
const riskStyles = {
  ...
  UNVERIFIED: { icon: ShieldAlert, dot: "bg-slate-400", text: "text-slate-600", bg: "bg-slate-50", border: "border-slate-200", },
};
...
const listRef = useRef(null);
  ...
  }, [bidders, searchQuery, riskFilter, complianceFilter, flaggedOnly]);
